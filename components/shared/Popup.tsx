      ...
      {({ open }) => (
        <>
          <Popover.Button
            ...
            } flex items-center justify-between w-full py-2 text-left bg-white focus:outline-none`}
            onMouseEnter={() => {
          ...
          >
            <Popover.Panel
              static
              className="absolute z-10 w-[250px] bottom-16 bg-white rounded shadow-md"
              ref={popupRef}
            >
              {content}
            </Popover.Panel>
